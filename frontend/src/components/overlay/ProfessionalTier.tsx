            ...
            <div className="flex flex-col items-center gap-[6vh] text-center w-full relative z-10">
                    ...
                    <AnimatePresence mode="wait">
                        {showName && (
                            <motion.div
                                ...
                                className="text-[clamp(3rem,8vw,8rem)] font-black text-white drop-shadow-[0_6px_15px_rgba(0,0,0,0.9)] break-words max-w-[90vw] leading-tight uppercase"
                            >
                                {donorName}
                            </motion.div>
                        )}
                            ...
                            >
                                <span className="text-[clamp(5rem,13vw,13rem)] font-black leading-none"
                                    style={{
                                        ...
                                        textShadow: '0 0 50px rgba(255,0,127,0.6), 0 10px 0 #581c87'
                                    }}
                                >
                ...
                <AnimatePresence mode="wait">
                    {showAmount && message && message.trim() && (
                        ...
                        >
                            <p className="text-[clamp(1.8rem,4.5vw,5rem)] font-bold text-white/95 leading-tight drop-shadow-[0_2px_10px_rgba(0,0,0,0.7)] break-words">
                                "{message}"
                            </p>
                        </motion.div>
                    )}
